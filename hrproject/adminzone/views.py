...
def updateemp(request):
    ...
    aadharno = request.POST['aadharno']
    salary = request.POST['salary']
    emp = Employee(empid=empid, empname=empname, gender=gender, address=address, contactno=contactno,
                   emailaddress=emailaddress, doj=doj, department=department, designation=designation, panno=panno,
                   aadharno=aadharno, salary=salary)
    emp.save()
    return redirect('adminzone:employee')
